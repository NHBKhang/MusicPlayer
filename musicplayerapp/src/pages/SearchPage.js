        ...
        <Page title={`Kết quả cho "${query}"`}>
            <div className="content-container" style={{ height: '85%' }}>
                <div style={{ width: '100%', position: 'relative' }}>
                    <MusicTabView tabs={tabs} query={query} activeTab={activeTab} onTabChange={handleTabChange} />
                </div>
            </div>
        </Page>
    );
    ...
    return (
        <div key={item.id} className='d-flex item'>
            ...
            <div className='ms-4 text-start mt-1'>
                <h5>{item.name}</h5>
                <div className='mb-2 mt-1 d-flex justify-content-evenly w-100'>
                ...
                <button className={`mt-1 mb-2 follow-button `}>
